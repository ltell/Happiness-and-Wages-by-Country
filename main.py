...
print(f"Countries with the largest average happiness score: {happiness_average_per_country.nlargest(10)}")
print(f"Countries with the smallest average happiness score: {happiness_average_per_country.nsmallest(10)}")